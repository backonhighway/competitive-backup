...
public class TheMatrix
{
	public int MaxArea(String[] board)
	{
		...
		for (int i = 0; i < xlen; i++) {
			for (int j = i+1; j <= xlen; j++) {
				int[] comp = new int[ylen]; // -1:bad, 0, 1
				for (int k = 0; k < ylen; k++) {
					comp[k] = getInt(board[k].substring(i, j));
				}
				int maxy = count(comp);
				ret = Math.max(ret, maxy * (j-i));
			}
		}
		return ret;
	}
	...
	public int getInt(String str) {
		...
		return ok ? str.charAt(0) - '0' : -1;
	}
	
	
	public int count(int[] comp) {
		int temp = 0;
		int ret = temp;
	...
	public static void main(String[] args) {
		...
		// ----- test 6 -----
		disabled = false;
		p0 = new String[]{"0000011", "0110101", "1101110", "1001101", "0011101", "1101011", "0001100", "0010011", "1101010", "1110011", "1101100", "0100110", "1010011", "0101011", "1100001", "1011111", "0101111", "1111010", "0011111", "1100011", "1110011", "1011100", "1110101"};
		p1 = 10;
		all_right = (disabled || KawigiEdit_RunTest(6, p0, true, p1) ) && all_right;
		tests_disabled = tests_disabled || disabled;
		// ------------------
	...
	// 
	// 
	// You are given a String[] board that represents a rectangular grid of cells, with a 0 or a 1 in each cell.
